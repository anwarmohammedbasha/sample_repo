"""
Extraction module for the Pending Payments & Owed Amount ETL job.

Reads sales and customer CSV data, parses dates, and merges both datasets
on a common key column.
"""
...
def extract(sales_path, customers_path, key_col='customer_id', date_col='order_date'):
    ...
    # Merge data
    merge_df = s_df.merge(c_df, how='left', on=key_col)
